...
<style>
  ...
  .pagination {
    ...
    gap: var(--sp-4); padding: var(--sp-5) 0 var(--sp-3);
  }
  .page-btn {
  ...
  .page-indicator { display: flex; align-items: baseline; gap: 4px; font-size: var(--text-sm); }
  .page-current { font-weight: 700; color: var(--color-text); font-size: var(--text-md); }
  .page-sep { color: var(--color-text-muted); }
  .page-total { color: var(--color-text-muted); }
  .state-card {
  ...
  @media (max-width: 768px) {
    ...
    .page-btn { padding: 6px 12px; font-size: var(--text-xs); }
  }
